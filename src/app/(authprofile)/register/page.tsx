        ...
        <div className="min-h-screen bg-white">
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            ...
            <div className="absolute bottom-0 left-0">
              <div className="h-60 w-60 rounded-full bg-linear-to-tr from-green-500/20 to-blue-500/20 blur-[100px]" />
            </div>
          </div>
              ...
              <div className="text-center">
                <div className="mb-4 border-y [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1]">
                  <div className="-mx-0.5 flex justify-center py-2">
                    <div className="w-12 h-12 bg-linear-to-r from-green-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
