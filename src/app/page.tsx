              ...
              <div className="pb-8 text-center md:pb-16">
                ...
                <div className="mx-auto max-w-3xl">
                  <p
                    ...
                    data-aos-delay={300}
                  >
                    Cantólico é uma plataforma digital gratuita criada para centralizar e organizar 
                    os cânticos católicos em língua portuguesa. Construído pela comunidade, para a comunidade.
                  </p>
                  <div className="relative before:absolute before:inset-0 before:border-y before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1]">
                    <div
                      className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center gap-3 md:gap-4 px-4 sm:px-0"
                      data-aos="zoom-y-out"
                      data-aos-delay={450}
                    >
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="pb-8 md:pb-12 lg:pb-20 text-center">
              ...
              <p className="text-base md:text-lg text-gray-700 max-w-2xl mx-auto px-4 sm:px-0">
                Tudo o que precisa para organizar a música litúrgica católica
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
              <div className="space-y-4 md:space-y-6 text-center lg:text-left">
                ...
                <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                  ...
                  um local onde músicos, cantores e comunidades católicas possam encontrar, 
                  partilhar e organizar música litúrgica de qualidade.
                </p>
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center gap-3 justify-center lg:justify-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0"></div>
                    <span className="text-sm md:text-base text-gray-800">Biblioteca completa de cânticos organizados por momento litúrgico</span>
                  </div>
                  <div className="flex items-center gap-3 justify-center lg:justify-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0"></div>
                    <span className="text-sm md:text-base text-gray-800">Partituras, acordes e letras sempre disponíveis</span>
                  </div>
                  <div className="flex items-center gap-3 justify-center lg:justify-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0"></div>
                    <span className="text-sm md:text-base text-gray-800">Criado pela comunidade católica, para a comunidade católica</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6 mt-8 lg:mt-0">
                ...
                <div className="text-center bg-gray-50 rounded-xl p-4 md:p-6">
                  ...
                  <p className="text-xs md:text-sm text-gray-600">Encontre rapidamente o que precisa</p>
                </div>
                <div className="text-center bg-gray-50 rounded-xl p-4 md:p-6">
                  ...
                  <p className="text-xs md:text-sm text-gray-600">Organize os seus cânticos preferidos</p>
                </div>
                <div className="text-center bg-gray-50 rounded-xl p-4 md:p-6">
                  ...
                  <p className="text-xs md:text-sm text-gray-600">Partilhe e colabore com outros</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="py-8 md:py-12 lg:py-20">
              <div className="relative mx-auto max-w-3xl text-center">
                ...
                <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center gap-3 md:gap-4 px-4 sm:px-0">
                  <Button asChild size="lg" className="mb-3 sm:mb-0 w-full bg-gradient-to-t from-blue-600 to-blue-500 text-white hover:from-blue-700 hover:to-blue-600 sm:w-auto text-base md:text-lg px-6 md:px-8 py-4 md:py-6">
                    <Link href="/musics">
                      Explorar Cânticos →
                    </Link>
